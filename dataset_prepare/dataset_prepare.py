...
name_vectors = name_vectorizer.fit_transform(dataset_merged["Name"].values.astype('U')).toarray()
...
description_vectors = description_vectorizer.fit_transform(dataset_merged["sypnopsis"].values.astype('U')).toarray()
...
all_vectors = sps.hstack([name_vectors, description_vectors, dict_vectors]).toarray()
