...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Studio_Combobox = QtWidgets.QComboBox(self.centralwidget)
        self.Studio_Combobox.setObjectName("Studio_Combobox")
        self.gridLayout.addWidget(self.Studio_Combobox, 5, 3, 1, 1)
